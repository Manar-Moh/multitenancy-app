<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        @empty(! $invitationEmail)
            <input type="hidden" name="tokenInvitation" value="{{ request('token') }}">
        @endempty
        ...
        <div class="mt-4">
            ...
            <x-text-input id="email" class="block mt-1 w-full" type="email" name="email" :value="old('email',$invitationEmail)" required autocomplete="username" :disabled="! is_null($invitationEmail)" /> {{-- [tl! ++] --}}
